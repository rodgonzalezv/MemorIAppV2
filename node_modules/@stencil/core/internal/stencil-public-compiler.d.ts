 ...
 */
type StrictConfigFields = keyof Pick<Config, 'cacheDir' | 'devServer' | 'devMode' | 'extras' | 'flags' | 'fsNamespace' | 'hydratedFlag' | 'logLevel' | 'logger' | 'namespace' | 'outputTargets' | 'packageJsonFilePath' | 'rollupConfig' | 'rootDir' | 'srcDir' | 'srcIndexHtml' | 'sys' | 'testing' | 'transformAliasedImportPaths' | 'validatePrimaryPackageOutputTarget'>;
/**
