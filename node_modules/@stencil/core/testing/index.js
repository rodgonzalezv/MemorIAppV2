  ...
  run: async (t = {}) => {
   ...
   try {
    ...
    t.e2e) {
     ...
     if (a && e.watch && (c = await s.createWatcher()), a) if (c) {
      const e = c;
      t = new Promise((t => {
